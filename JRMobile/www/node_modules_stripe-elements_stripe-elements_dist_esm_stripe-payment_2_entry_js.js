"use strict";
(self["webpackChunkapp"] = self["webpackChunkapp"] || []).push([["node_modules_stripe-elements_stripe-elements_dist_esm_stripe-payment_2_entry_js"],{

/***/ 3936:
/*!******************************************************************************************!*\
  !*** ./node_modules/@stripe-elements/stripe-elements/dist/esm/stripe-payment_2.entry.js ***!
  \******************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "stripe_payment": () => (/* binding */ StripePayment),
/* harmony export */   "stripe_sheet": () => (/* binding */ StripeSheet)
/* harmony export */ });
...
const StripePayment = class {
  constructor(hostRef) {
    ...
    this.formSubmit = (0,_index_a7e5d6fd_js__WEBPACK_IMPORTED_MODULE_1__.c)(this, "formSubmit", 7);
    this.defaultFormSubmitResult = (0,_index_a7e5d6fd_js__WEBPACK_IMPORTED_MODULE_1__.c)(this, "defaultFormSubmitResult", 7);
    /**
  ...
  initStripe(publishableKey, options = undefined) {
    ...
    return (0,e_Capstone_JRMobile_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      _this9.loadStripeStatus = 'loading';
      (0,_stripe_esm_ea56157a_js__WEBPACK_IMPORTED_MODULE_2__.l)(publishableKey, {
        ...
        _this9.loadStripeStatus = 'success';
        stripe.registerAppInfo({
          name: _this9.applicationName
        });
        _this9.stripe = stripe;
        return;
      }).catch(e => {
        console.log(e);
        _this9.errorMessage = e.message;
        _this9.loadStripeStatus = 'failure';
        return;
      }).then(() => {
        if (!_this9.stripe) {
          return;
        ...
        return _this9.initElement();
      }).then(() => {
        if (!_this9.stripe) {
          return;
        }

        _this9.stripeLoadedEventHandler();
      });
    })();
  }
  /**
  ...
  setErrorMessage(errorMessage) {
    ...
    return (0,e_Capstone_JRMobile_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      _this11.errorMessage = errorMessage;
      return _this11;
    })();
  }
  /**
  ...
  setPaymentRequestOption(option) {
    ...
    return (0,e_Capstone_JRMobile_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      _this12.paymentRequestOption = option;

      _this12.createPaymentRequestButton();
  ...
  defaultFormSubmitResultHandler(result) {
    var _this14 = this;

    return (0,e_Capstone_JRMobile_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      _this14.defaultFormSubmitResult.emit(result);
    })();
  }
  ...
  defaultFormSubmitAction(event, {
    ...
    return (0,e_Capstone_JRMobile_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      try {
        ...
        _this15.defaultFormSubmitResultHandler(result);
      } catch (e) {
        _this15.defaultFormSubmitResultHandler(e);
  ...
  initElement() {
    ...
    return (0,e_Capstone_JRMobile_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const elements = _this16.stripe.elements();

      const handleCardError = ({
        error
      }) => {
        if (error) {
          _this16.errorMessage = error.message;
        } else {
          _this16.errorMessage = '';
        }
      };

      _this16.cardNumber = elements.create('cardNumber', {
        placeholder: i18n.t('Card Number')
      });
      const cardNumberElement = yield waitForElm(_this16.el, '#card-number');

      _this16.cardNumber.mount(cardNumberElement);

      _this16.cardNumber.on('change', handleCardError);

      _this16.cardExpiry = elements.create('cardExpiry');
      const cardExpiryElement = yield waitForElm(_this16.el, '#card-expiry');

      _this16.cardExpiry.mount(cardExpiryElement);

      _this16.cardExpiry.on('change', handleCardError);

      _this16.cardCVC = elements.create('cardCvc');
      const cardCVCElement = yield waitForElm(_this16.el, '#card-cvc');

      _this16.cardCVC.mount(cardCVCElement);

      _this16.cardCVC.on('change', handleCardError);

      document.getElementById('stripe-card-element').addEventListener('submit', /*#__PURE__*/function () {
        var _ref = (0,e_Capstone_JRMobile_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (e) {
          ...
          const submitEventProps = {
            ...
            stripe,
            intentClientSecret,
            zipCode: _this16.zipCode
          };
          _this16.progress = 'loading';

          try {
            if (_this16.handleSubmit) {
              yield _this16.handleSubmit(e, submitEventProps);
            } else if (_this16.shouldUseDefaultFormSubmitAction === true && intentClientSecret) {
              yield _this16.defaultFormSubmitAction(e, submitEventProps);
            } else {
              e.preventDefault();
            }

            yield _this16.formSubmitEventHandler();

            if (_this16.handleSubmit || _this16.shouldUseDefaultFormSubmitAction === true) {
              _this16.progress = 'success';
            }
          } catch (e) {
            _this16.errorMessage = e.message;
            _this16.progress = 'failure';
          }
        });
  ...
  render() {
    ...
    if (this.loadStripeStatus === 'failure') {
      return (0,_index_a7e5d6fd_js__WEBPACK_IMPORTED_MODULE_1__.h)("p", null, i18n.t('Failed to load Stripe'));
    }

    const disabled = this.progress === 'loading';
    return (0,_index_a7e5d6fd_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
      class: "stripe-payment-sheet-wrap"
    }, (0,_index_a7e5d6fd_js__WEBPACK_IMPORTED_MODULE_1__.h)("form", {
      id: "stripe-card-element"
    }, (0,_index_a7e5d6fd_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
      class: "stripe-heading"
    }, i18n.t(this.sheetTitle)), (0,_index_a7e5d6fd_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
      id: "stripe-payment-request-button"
    }), (0,_index_a7e5d6fd_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", null, (0,_index_a7e5d6fd_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
      class: "stripe-section-title"
    }, i18n.t('Card information'))), (0,_index_a7e5d6fd_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
      class: "payment-info card visible"
    }, (0,_index_a7e5d6fd_js__WEBPACK_IMPORTED_MODULE_1__.h)("fieldset", {
      class: "stripe-input-box"
    }, (0,_index_a7e5d6fd_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", null, (0,_index_a7e5d6fd_js__WEBPACK_IMPORTED_MODULE_1__.h)("label", null, this.showLabel ? (0,_index_a7e5d6fd_js__WEBPACK_IMPORTED_MODULE_1__.h)("lenged", null, i18n.t('Card Number')) : null, (0,_index_a7e5d6fd_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
      id: "card-number"
    }))), (0,_index_a7e5d6fd_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
      class: "stripe-input-column",
      style: {
        display: 'flex'
      }
    }, (0,_index_a7e5d6fd_js__WEBPACK_IMPORTED_MODULE_1__.h)("label", {
      style: {
        width: '50%'
      }
    }, this.showLabel ? (0,_index_a7e5d6fd_js__WEBPACK_IMPORTED_MODULE_1__.h)("lenged", null, i18n.t('MM / YY')) : null, (0,_index_a7e5d6fd_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
      id: "card-expiry"
    })), (0,_index_a7e5d6fd_js__WEBPACK_IMPORTED_MODULE_1__.h)("label", {
      style: {
        width: '50%'
      }
    }, this.showLabel ? (0,_index_a7e5d6fd_js__WEBPACK_IMPORTED_MODULE_1__.h)("lenged", null, i18n.t('CVC')) : null, (0,_index_a7e5d6fd_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
      id: "card-cvc"
    }))), (0,_index_a7e5d6fd_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
      id: "card-errors",
      class: "element-errors"
    }, errorMessage))), this.zip ? (0,_index_a7e5d6fd_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
      style: {
        marginTop: '1.5rem'
      }
    }, (0,_index_a7e5d6fd_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
      class: "stripe-section-title"
    }, i18n.t('Country or region'))) : null, this.zip ? (0,_index_a7e5d6fd_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
      class: "payment-info card visible"
    }, (0,_index_a7e5d6fd_js__WEBPACK_IMPORTED_MODULE_1__.h)("fieldset", {
      class: "stripe-input-box"
    }, (0,_index_a7e5d6fd_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", null, (0,_index_a7e5d6fd_js__WEBPACK_IMPORTED_MODULE_1__.h)("label", null, this.showLabel ? (0,_index_a7e5d6fd_js__WEBPACK_IMPORTED_MODULE_1__.h)("lenged", null, i18n.t('Postal Code')) : null, (0,_index_a7e5d6fd_js__WEBPACK_IMPORTED_MODULE_1__.h)("input", {
      id: "zip",
      name: "zip",
      type: "text",
      inputmode: "numeric",
    ...
    }))))) : null, (0,_index_a7e5d6fd_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
      style: {
        marginTop: '32px'
      }
    }, (0,_index_a7e5d6fd_js__WEBPACK_IMPORTED_MODULE_1__.h)("button", {
      type: "submit",
      disabled: disabled
...
StripePayment.style = stripePaymentSheetCss;
...
const StripeSheet = class {
  constructor(hostRef) {
    (0,_index_a7e5d6fd_js__WEBPACK_IMPORTED_MODULE_1__.r)(this, hostRef);
    this.close = (0,_index_a7e5d6fd_js__WEBPACK_IMPORTED_MODULE_1__.c)(this, "close", 7);
    /**
  ...
  toggleModal() {
    ...
    return (0,e_Capstone_JRMobile_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      _this17.open = !_this17.open;

      if (_this17.open === false) {
        _this17.close.emit();
      }
    })();
  }
  ...
  render() {
    ...
    return (0,_index_a7e5d6fd_js__WEBPACK_IMPORTED_MODULE_1__.h)(_index_a7e5d6fd_js__WEBPACK_IMPORTED_MODULE_1__.H, null, (0,_index_a7e5d6fd_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
      class: `modal-row${open ? ' open' : ''}`,
      onClick: () => this.closeModal()
    }, (0,_index_a7e5d6fd_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
      class: "modal-child",
      onClick: e => e.stopPropagation()
    }, showCloseButton ? (0,_index_a7e5d6fd_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
      class: "modal-close-button-wrap"
    }, (0,_index_a7e5d6fd_js__WEBPACK_IMPORTED_MODULE_1__.h)("ion-icon", {
      name: "close",
      size: "large",
      class: "modal-close-button",
      onClick: () => this.closeModal()
    })) : null, (0,_index_a7e5d6fd_js__WEBPACK_IMPORTED_MODULE_1__.h)("slot", null))));
  }
...
StripeSheet.style = stripeElementModalCss;


/***/ })

}]);
//# sourceMappingURL=node_modules_stripe-elements_stripe-elements_dist_esm_stripe-payment_2_entry_js.js.map